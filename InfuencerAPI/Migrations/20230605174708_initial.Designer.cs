...
namespace InfuencerAPI.Migrations
{
    ...
    [Migration("20230605174708_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InfuencerAPI.Models.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InfuencerAPI.Models.Orders.Target", b =>
                {
                    ...
                    b.Property<Guid?>("TargetSettingId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TargetSettingId");

                    b.ToTable("OrderTargets");
                });

            modelBuilder.Entity("InfuencerAPI.Models.Settings.Setting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InfuencerAPI.Models.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InfuencerAPI.Models.Influencers.Influencer", b =>
                {
                    b.HasOne("InfuencerAPI.Models.Settings.Setting", "Gender")
                        .WithMany()
                        .HasForeignKey("GenderId");

                    b.HasOne("InfuencerAPI.Models.Settings.Setting", "Industry")
                        .WithMany()
                        .HasForeignKey("IndustryId");

                    b.HasOne("InfuencerAPI.Models.Settings.Setting", "Nationality")
                        .WithMany()
            ...
            modelBuilder.Entity("InfuencerAPI.Models.Influencers.Service", b =>
                {
                    ...
                    b.HasOne("InfuencerAPI.Models.Settings.Setting", "ServiceSetting")
                        .WithMany()
                        .HasForeignKey("ServiceSettingId");

                    b.HasOne("InfuencerAPI.Models.Settings.Setting", "Type")
                        .WithMany()
            ...
            modelBuilder.Entity("InfuencerAPI.Models.Influencers.Social", b =>
                {
                    ...
                    b.HasOne("InfuencerAPI.Models.Settings.Setting", "SocialMedia")
                        .WithMany()
            ...
            modelBuilder.Entity("InfuencerAPI.Models.Influencers.Time", b =>
                {
                    ...
                    b.HasOne("InfuencerAPI.Models.Settings.Setting", "TimeSetting")
                        .WithMany()
            ...
            modelBuilder.Entity("InfuencerAPI.Models.Orders.Calendar", b =>
                {
                    b.HasOne("InfuencerAPI.Models.Orders.Order", "Order")
                        .WithMany()
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InfuencerAPI.Models.Settings.Setting", "Time")
                        .WithMany()
            ...
            modelBuilder.Entity("InfuencerAPI.Models.Orders.Detail", b =>
                {
                    ...
                    b.HasOne("InfuencerAPI.Models.Settings.Setting", "ServiceType")
                        .WithMany()
            ...
            modelBuilder.Entity("InfuencerAPI.Models.Orders.Order", b =>
                {
                    ...
                    b.HasOne("InfuencerAPI.Models.Users.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("InfuencerAPI.Models.Orders.Target", b =>
                {
                    ...
                    b.HasOne("InfuencerAPI.Models.Settings.Setting", "TargetSetting")
                        .WithMany()
                        .HasForeignKey("TargetSettingId");

                    b.Navigation("Order");

                    b.Navigation("TargetSetting");
                });
